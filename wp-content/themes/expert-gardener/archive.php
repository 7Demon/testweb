...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
	            $expert_gardener_archive_sidebar_setting = get_theme_mod('expert_gardener_archive_sidebar_setting','1');
	            $expert_gardener_sidebar_position = get_theme_mod('expert_gardener_sidebar_position', 'right');
	            $expert_gardener_content_class = ($expert_gardener_archive_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $expert_gardener_archive_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
