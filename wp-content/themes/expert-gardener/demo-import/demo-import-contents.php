...
class Whizzie {
			...
			<div class="card whizzie-wrap">
				<div class="demo_content_image">
					...
					<div class="demo_image">
						...
						<img src="<?php echo esc_url( get_template_directory_uri() . '/screenshot.png' ); ?>" alt="<?php echo esc_attr( $expert_gardener_theme_title ); ?>" />
					</div> <!-- .demo_image -->
	...
	public function setup_widgets(){
		...
		/* -------------- Slider ------------------*/
			...
			set_theme_mod('expert_gardener_slider_short_heading', 'Welcome to Ganden Landscaping');
